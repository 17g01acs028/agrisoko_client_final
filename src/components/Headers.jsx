            ...
            <div className="w-3/12 md-lg:w-full">
              <div className="bg-white relative">
                <div
                  ...
                  className="h-[50px] bg-[#68d66f] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
                >
              ...
              <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
                <div className="w-8/12 md-lg:w-full">
                  <div className="flex border h-[50px] items-center relative gap-5">
                    ...
                    <button
                      onClick={search}
                      className="bg-[#68d66f] right-0 absolute px-8 h-full font-semibold uppercase text-white"
                    >
                      Search
                    </button>
                  </div>
